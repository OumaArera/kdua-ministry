...
export const managementTeam = [
    ...
    },
    {
      ...
      role: "Project Coordinator (Orphans)",
      experience: `
        Linda Barnie Effah holds a Bachelor of Science degree in Management Studies from Central University College. 
        She has a great sense of achieving something and the ability to manage any difficult situations around her. 
        She has a strong, ethical and moral stance and has worked with Ghana Hockey Association as a secretary and 
        she worked with GRA (Customs Division) and also worked with Fanteakwa District Assembly as the Asst. 
        Development Planning Officer. She plays  for the national hockey team,and currently with GRA (Customs Division) club. 
