...
const Education = ({ onClose }) => {
  ...
  const totalPages = Math.ceil(education.length / imagesPerPage);
  const currentImages = education.slice(currentPage * imagesPerPage, (currentPage + 1) * imagesPerPage);
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              <p className="text-purple-100 text-sm mt-1">
                {education.length} images • Supporting education for underprivileged children
              </p>
            </div>
              ...
              return (
                ...
                >
                  <div className="aspect-square bg-gradient-to-br">
                    <img
                      src={image}
                      alt={`Educational support ${globalIndex + 1}`}
            ...
            <div className="flex justify-center space-x-8 text-center">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Students Aided</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Books Donated</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div className="fixed inset-0 bg-black/50 bg-opacity-90 z-60 flex items-center justify-center p-4">
            <div className="relative max-w-4xl max-h-[90vh]">
              ...
              <img
                ...
                alt={`Educational support ${selectedImage.index + 1}`}
                className="max-w-full max-h-full object-contain rounded-2xl shadow-2xl"
              />
              <div className="absolute bottom-4 left-4 text-white bg-black/50 backdrop-blur-sm px-4 py-2 rounded-lg">
                <div className="font-semibold">Educational Support Program</div>
                <div className="text-sm opacity-75">Image {selectedImage.index + 1} of {education.length}</div>
              </div>
            </div>
          </div>
        )}
