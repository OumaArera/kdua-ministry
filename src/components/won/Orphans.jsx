    ...
    <div className="fixed inset-0 bg-black/50 bg-opacity-50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-7xl w-full max-h-[95vh] overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold flex items-center justify-center space-x-2">
                ...
                <span>Orphan Care Initiative</span>
              </h1>
              <p className="text-blue-100 text-sm mt-1">
                {orphans.length} images • Providing care and support for orphaned children
              </p>
            </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(95vh-120px)]">
              ...
              return (
                ...
                >
                  <div className="aspect-square bg-gradient-to-br ">
                    <img
                      src={image}
                      alt={`Orphan care program ${globalIndex + 1}`}
                  ...
                  {/* Image number badge */}
                  <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm text-blue-600 text-xs font-bold px-2 py-1 rounded-full">
                    {globalIndex + 1}
                  </div>
                </div>
              );
          ...
          <div className="mt-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-4">
            <div className="flex justify-center space-x-8 text-center">
              <div className="flex items-center space-x-2">
                <Baby className="w-5 h-5 text-blue-600" />
                <div>
                  <div className="text-lg font-bold text-gray-800">200+</div>
                  <div className="text-xs text-gray-600">Children Cared For</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Care Provided</div>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-600">Care Centers</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="fixed inset-0 bg-black/50 bg-opacity-90 z-60 flex items-center justify-center p-4">
            <div className="relative max-w-4xl max-h-[90vh]">
              ...
              <img
                ...
                alt={`Orphan care program ${selectedImage.index + 1}`}
                className="max-w-full max-h-full object-contain rounded-2xl shadow-2xl"
              />
              <div className="absolute bottom-4 left-4 text-white bg-black/50 backdrop-blur-sm px-4 py-2 rounded-lg">
                <div className="font-semibold">Orphan Care Initiative</div>
                <div className="text-sm opacity-75">Image {selectedImage.index + 1} of {orphans.length}</div>
              </div>
            </div>
          </div>
        )}
